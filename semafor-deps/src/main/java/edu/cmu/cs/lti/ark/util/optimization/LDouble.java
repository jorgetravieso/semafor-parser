...
/**
 * Log-Double. A class to represent a double value along with a boolean indicating whether the exponentiated value should be
...
public class LDouble implements Serializable {
    ...
    /**
     * Default constructor initializes value to be the plus-identity element in the (logplus, plus) semiring. (Initialize as
     * LDouble(0.0) for the times-identity element)
     */
    public LDouble() {
        value = NEG_INF;
        sign = true;
