...
/**
 * Class to represent a function. Format is a tree structure, in which leaf nodes are table look-ups for parameter values and
 * non-leaf nodes are operations, such as TIMES, PLUS, DIVIDE, etc. Every node of this "formula tree" is an instance of a Formula
 * Object.
 *
 * @author Kevin Gimpel, Noah Smith 2/21/07
 */
