...
/**
 * This interface is used by classes whose objects are sorted in some sort
 * of hierarchy. The interface provides methods to display the hierarchy
 * in tree form as ASCII output. What relation the backbone of the hierarchy 
 * is, is up to the class.
 * 
 * @author Nils Reiter
 *
 */
