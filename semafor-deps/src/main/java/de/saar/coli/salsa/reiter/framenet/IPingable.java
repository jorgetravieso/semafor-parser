 ...
 * 
 * <i>This interface is not used in version 0.1, but expected to be used in future versions.</i>
 * 
 * @author Nils Reiter
 *
 */
public interface IPingable extends Runnable {
	...
	/**
	 * The frame loading procedure tries to set the maximal number of pings required
	 * before starting the loading procedure.
	 * @param n The number of pings required
	 */
