...
public class STXExporter extends Exporter {
	 ...
	 */
	public STXExporter() {
		this.namespace = new Namespace("", "http://www.clt-st.de/framenet/frame-database");
	}
	
	/**
	 * Adds the frame definitions to an existing Tiger XML document
	 * @param frameNet The FrameNet object
	 * @param tigerXML The XML document
	 * @return The new SalsaTigerXML document
	 */
	public Document getDocument(FrameNet frameNet, Document tigerXML) {
	...
	/**
	 * Returns a new XML document with the frame definitions and the given corpusId
	 * @param frameNet The FrameNet object
	 * @param corpusId The corpus id
	 * @return The new XML document
	 */
	public Document getDocument(FrameNet frameNet, String corpusId) {
	 ...
	 * @return The new XML document
	 */
	public Document getDocument(FrameNet frameNet, String corpusId, Element meta) {
	...
	/**
	 * Returns a partial XML document, containing just the frame definitions
	 * in SalsaTigerXML-style
	 * @param frameNet The FrameNet object
	 * @return The XML element "frames"
	 */
	public Element getXMLElementFrames(FrameNet frameNet) {
		return this.getXMLElementFrames(frameNet.getFrames());
	}
	
	/** 
	 * Returns a partial XML document containing selected frame definitions 
	 * in SalsaTigerXML-style
	 * @param frames The frames we want to export
	 * @return The XML element frames
	 */
	public Element getXMLElementFrames(Collection<Frame> frames) {
	...
	protected Element getFrame(Frame frame) {
	...
	protected Element getFrameElement(FrameElement fe) {
